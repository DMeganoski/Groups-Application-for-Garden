 ...
 */
class TranslationsController extends GroupsController {
    ...
    */
   public function Add() {
		$this->Permission('Groups.Translations.Add');
      $UserLanguageModel = new UserLanguageModel();
   ...
   public function View($UserLanguageID = '') {
      ...
      if (!$this->UserLanguage)
		...
		if ($UserLanguageModel->GetWhere(
         ...
         $this->Permission('Groups.Translations.Manage');
   ...
   public function Delete($UserLanguageID = '') {
	...
	public function ImportLanguages() {
		$this->Permission('Groups.Languages.Manage'); // Only root admins can run this method
		$LanguageModel = new Gdn_Model('Language');
		$Arr = array();
